...
const Populars = () => {
  return (
    <div className="flex h-screen flex-col items-center justify-between bg-dark-blue md:max-h-656px">
      <h1
      ...
      <div
        className="mt-6 flex h-full w-full flex-wrap items-end
				justify-center gap-x-1.5 md:max-w-4xl md:flex-row md:justify-between"
      >
